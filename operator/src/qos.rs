...
//! heartbeat transaction containing on-chain metrics.
//!
//! The heartbeat serves two purposes:
//! 1. Liveness proof -- the chain knows this operator is alive
//! 2. Metric submission -- job counts, error rates feed into reputation
...
async fn send_heartbeat(
    ...
    // Submit minimal heartbeat (no custom metrics for now)
    let metric_pairs: Vec<IOperatorStatusRegistry::MetricPair> = Vec::new();
